...
urlpatterns = [
    ...
    # Updated URL pattern to avoid overlap
    ...
    # Login and Logout using path() instead of re_path()
    re_path(r'^login/', auth_views.LoginView.as_view(template_name='log_in.html'), name='login'),
